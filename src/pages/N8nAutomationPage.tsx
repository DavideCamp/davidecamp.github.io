...
import { FlowCurvesBackground } from '../components/n8n/FlowCurvesBackground';
...
const N8nAutomationPage = () => {
  ...
  return (
    <div className="relative ios-glass-bg text-slate-900 dark:text-slate-100">
      <FlowCurvesBackground />
